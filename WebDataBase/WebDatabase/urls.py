...
urlpatterns = [
    ...
    path("PartAliasByID",views.GetPartAliasByID,name="PartAliasByID"),
    ...
    path("PlasmidAliasByID",views.GetPlasmidAliasByID,name="PlasmidAliasByID"),
    ...
    path("BackboneAliasByID",views.GetBackboneAliasByID,name="BackboneAliasByID"),
    ...
    path("GetPlasmidRelations", views.GetPlasmidRelations, name="GetPlasmidRelations"),
    path("GetUploadRecords", views.GetUploadRecords, name="GetUploadRecords"),
    ...
    path("createVisitorProfile", views.createVisitorProfile, name="createVisitorProfile"),
    path("getVisitorProfile", views.getVisitorProfile, name="getVisitorProfile"),
    ...
    path("listVisitorAccessLogs", views.listVisitorAccessLogs, name="listVisitorAccessLogs"),
